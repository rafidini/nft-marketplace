...
import type { ClientSafeProvider, RedirectableProvider, SessionProviderProps, SignInAuthorisationParams, SignInOptions, SignInResponse, SignOutParams, SignOutResponse, UseSessionOptions } from "./types";
export * from "./types";
 ...
 */
export declare function getProviders(): Promise<Record<RedirectableProvider, ClientSafeProvider> | null>;
/**
 ...
 */
export declare function signIn<P extends RedirectableProvider | undefined = undefined>(provider?: RedirectableProvider, options?: SignInOptions, authorizationParams?: SignInAuthorisationParams): Promise<P extends RedirectableProvider ? SignInResponse | undefined : undefined>;
/**
